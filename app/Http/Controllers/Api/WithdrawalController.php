...
class WithdrawalController extends ApiController
{
    ...
    public function uploadCSV(Request $request, $fund_id) {
         ...
         */
        $upload_headers = [];
        $expected_headers = [ 'ユーザーID', '摘要', '日付', '金額' ];
    ...
    public function getCSVUploadFormat(Request $request) {
        ...
        $callback = function () {
            $columns = [
                ...
                mb_convert_encoding('摘要',"SJIS-win", "UTF-8"),
                mb_convert_encoding('日付',"SJIS-win", "UTF-8"),
                mb_convert_encoding('金額',"SJIS-win", "UTF-8"),
            ];
            ...
            fputcsv($file, 
                [
                    ...
                    mb_convert_encoding('分配金＋投資金額',"SJIS-win", "UTF-8"),
                    mb_convert_encoding('2022-01-20',"SJIS-win", "UTF-8"),
                    mb_convert_encoding('10000',"SJIS-win", "UTF-8"),
                ]
            );
            fclose($file);
        };
