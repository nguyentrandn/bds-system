...
<div id="breadcrumbs">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ファンド新規作成</li>
        </ol>
    </nav>
</div>
@endsection
...
<div class="main-conten fund-screen">
    <form class="row-conten" id="form" onsubmit="return false" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="coll-md-8 edit-padding">
                <div class="w30">
                    <input data-for-calculating="true" class="form-control w30" name="募集金額" placeholder="数字を入力"
                        type="number" min="0">
                </div>
                <div class="or">円</div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="coll-md-8 edit-padding">
                <div class="w30">
                    <input class="form-control w30" name="郵便番号" placeholder="数字を入力" type="text" autocomplete="off">
                </div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="coll-md-8 edit-padding">
                <input class="form-control" name="住所" placeholder="入力してください" type="text" autocomplete="off">
            </div>
        </div>
        <div class="form-group">
            <div class="coll-md-3 ">
...
$(document).ready(function() {
     ...
     */
    initialImageFileUploader('サブ画像_img_upload', [], 5);

    /**
     * Inital data for block メイン画像
     */
    initialImageFileUploader('メイン画像_img_upload', [], 1);

    /**
     * Inital data for block チラシ画像
     */
    initialImageFileUploader('チラシ画像_img_upload', [], 1);
    ...
    $("#submit_form").click(function() {
        ...
        $.ajax({
            ...
            .done(function(response) {
                ...
                setTimeout(function() {
                    location.assign(
                        `/admin/FD30?fund_id=${response.result.id}`);
                }, 2000);
            })
            .fail(function(error) {
