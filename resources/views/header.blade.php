...
<div class="menuLeftWrap">
  ...
  <div class="menuList clickTarget">
    ...
    <ul>
      ...
      <li>
        <a href="/fund">ファンド一覧</a>
      </li>
      <li class="member">
        <a href="/user/my20">入出金履歴</a>
      </li>
      <li class="tradingHistory member">
        <p>取引履歴</p>
        <ul>
          <li>
          ...
          <li>
            <a href="/user/my40">投資履歴一覧</a>
          </li>
          <li>
            <a href="/user/my50">抽選申込履歴一覧</a>
          </li>
        </ul>
      </li>
      <li class="member">
        <a href="/user/my70">会員情報</a>
      </li>
      <li class="nonmember">
        <a href="/sp40">運営会社</a>
      </li>
...
<ul class="loginArea">
  ...
  @if($user)
  <li class="nonmember name">
    <span style="cursor: pointer;" onclick="location.href='/my-page'">{{$user->お名前1}}{{$user->お名前2}}</span>様
  </li>
  <li class="nonmember out">
    <a href="/ajax/user/signout">ログアウト</a>
  </li>
  @endif
...
<script type="text/javascript">
  ...
  // tradingHistory
  $(function () {
    $('.tradingHistory ul').hide();
    $('.tradingHistory p').click(function () {
